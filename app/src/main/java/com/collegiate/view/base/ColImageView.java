 ...
 */
public class ColImageView extends GenericDraweeView {
    ...
    public ColImageView(Context context, GenericDraweeHierarchy hierarchy) {
        super(context, hierarchy);
    }

    public ColImageView(Context context) {
        super(context);
    }

    public ColImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ColImageView(Context context, AttributeSet attrs, int defStyle) {
